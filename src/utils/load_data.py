...
def load_dataset_session_2():
    # this version of database had 15 features for each channel (in total 10 channel) making 150 features
    # for each subject we have 3 seperate databases for 3 rounds
    print("LOAD DATASETS\n\n:")
    N_Subj = 2  # 11 subjects
    df_r1 = [0] * N_Subj  # dataframe for round1 for all subjects
    df_r2 = [0] * N_Subj  # dataframe for round2 for all subjects
    df_r3 = [0] * N_Subj  # dataframe for round3 for all subjects
    ...
    for i in range(0, N_Subj):
        df_r1[i] = pd.read_csv(
            "C:\\Users\\noemi\\Desktop\\university\\university\\tesi\\Thesis-XAI\\resources\\data_features\\Feature database_V3_session2\\database_v3_sbj{}_s2_WL512_S128_r1.csv".format(
                i + 7))
        df_r1[i].columns = cl_names

        df_r2[i] = pd.read_csv(
            "C:\\Users\\noemi\\Desktop\\university\\university\\tesi\\Thesis-XAI\\resources\\data_features\\Feature database_V3_session2\\database_v3_sbj{}_s2_WL512_S128_r2.csv".format(
                i + 7))
        df_r2[i].columns = cl_names

        df_r3[i] = pd.read_csv(
            "C:\\Users\\noemi\\Desktop\\university\\university\\tesi\\Thesis-XAI\\resources\\data_features\\Feature database_V3_session2\\database_v3_sbj{}_s2_WL512_S128_r3.csv".format(
                i + 7))
        df_r3[i].columns = cl_names
